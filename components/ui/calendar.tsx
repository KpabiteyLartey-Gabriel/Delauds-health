  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        table: "w-full border-collapse space-y-1 min-w-[320px] sm:min-w-0 overflow-x-auto block",
        head_row: "",
        head_cell: "text-muted-foreground rounded-md font-normal text-[0.8rem] px-1 py-1",
        row: "",
